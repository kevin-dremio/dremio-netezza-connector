# Dremio Netezza ARP Connector

The Netezza connector allows Dremio to connect to and query data in IBM Netezza.

## Building and Installation

1. In root directory with the pom.xml file run `mvn clean install`
2. Take the resulting .jar file in the target folder and put it in the $DREMIO_HOME/jars folder in Dremio
3. Download the Netezza JDBC driver from your Netezza deployment (/nz/kit.x.x.x.x/sbin/nzjdbc3.jar) and put in in the $DREMIO_HOME/jars/3rdparty folder.
4. Restart Dremio
