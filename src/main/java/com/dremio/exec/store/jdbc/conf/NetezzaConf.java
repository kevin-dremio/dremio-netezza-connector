 ...
 */
@SourceType(value = "NETEZZAARP", label = "Netezza")
public class NetezzaConf extends AbstractArpConf<NetezzaConf> {
  ...
  @NotBlank
  @Tag(3)
  @DisplayMetadata(label = "Schema/Database")
  ...
  public String toJdbcConnectionString() {
    ...
    final String database = checkNotNull(this.database, "Missing schema/database.");

    return String.format("jdbc:netezza://%s:%s/%s", host, port, database);
  }
